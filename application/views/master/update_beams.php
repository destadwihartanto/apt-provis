...
<div class="col-md-6">
    <div class="card card-info">
        ...
        <!-- form start -->
        <form class="form" method="post" action="<?= site_url('masterdata/update_beams/' . $id); ?>" enctype="multipart/form-data">
            <div class="card-body">
                <?= validation_errors() ?>
            ...
            <div class="card-footer">
                ...
                <a href="<?= site_url('masterdata/beams') ?>" class="btn btn-danger"><i class="fa fa-times-circle"></i> Batal</a>
            </div>
        </form>
    </div> <!-- /.card -->
</div>
