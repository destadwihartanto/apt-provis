    ...
    <div class="card card-info">
        ...
        <form class="form" method="post" action="<?= site_url('xpole/update/' . $id); ?>" enctype="multipart/form-data">
            ...
            <div class="card-footer">
                ...
                <a href="<?= site_url('xpole/index') ?>" class="btn btn-dark"><i class="fa fa-times-circle"></i> Batal</a>
            </div>
        </form>
    </div> <!-- /.card -->
</div>
...
<div class="col-lg-12">
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        ...
        <p>1.Halaman ini menampilkan data update xpole dan upload lampiran <br>
            2.Format Gambar harus JPEG </p>
